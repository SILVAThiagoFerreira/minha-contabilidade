...
for (const marker of ["data-view-target=\"cartoes\"", "id=\"cardForm\"", "id=\"cardPaymentForm\"", "id=\"cardAccount\"", "id=\"cardPaymentCard\"", "id=\"cardPaymentTable\""]) assert.match(html, new RegExp(marker), `interface ausente: ${marker}`);
