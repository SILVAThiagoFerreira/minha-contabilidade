...
const required = ["index.html", "styles.css", "config.js", "app.js", "README.md", ".github/workflows/deploy-pages.yml", "backend/Code.gs"];
...
for (const marker of ["PBKDF2", "AES-GCM", "saveCurrentVault", "renderAnalyses", "loadGoogleAuth"]) assert.match(js, new RegExp(marker), `regra ausente: ${marker}`);
assert.match(workflow, /actions\/deploy-pages@v4/);
assert.match(backend, /verifyIdToken_/);
